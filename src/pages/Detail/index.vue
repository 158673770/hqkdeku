...
export default {
  ...
  methods:{
    changeActive(spuSaleAttrValue,Attrfard){
      // console.log("spuSaleAttrValue",spuSaleAttrValue,"Attrfard",Attrfard)
      Attrfard.forEach(item => {
        item.isChecked = "0"
